...
WebUI.callTestCase(findTestCase('SecondHand/Login_/Input Email'), [('email') : "telowed836@apifan.com"], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SecondHand/Login_/Input Password'), [('password') : "telowed836"], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Daftar Jual Saya/i_Produk Saya_bi bi-list-ul me-4 me-lg-0'))