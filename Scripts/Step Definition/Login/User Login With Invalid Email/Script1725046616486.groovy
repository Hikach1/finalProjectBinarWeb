...
WebUI.callTestCase(findTestCase('SecondHand/Login_/Input Email'), [('email') : 'hikach1@gmail.com'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('SecondHand/Login_/Verify Error Login'), [('expected') : 'Invalid Email or password.'], FailureHandling.STOP_ON_FAILURE)
