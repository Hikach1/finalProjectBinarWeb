...
WebUI.callTestCase(findTestCase('SecondHand/Login_/Input Email'), [('email') : GlobalVariable.email], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SecondHand/Login_/Input Password'), [('password') : 123], FailureHandling.STOP_ON_FAILURE)
