...
WebUI.callTestCase(findTestCase('Pages/Login Page/Set Email Login'), [('emailLog') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Login Page/Set Password Login'), [('passwordLog') : ''], FailureHandling.STOP_ON_FAILURE)
