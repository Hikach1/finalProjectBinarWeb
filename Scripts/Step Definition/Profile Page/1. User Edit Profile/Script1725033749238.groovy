...
WebUI.callTestCase(findTestCase('Pages/Login Page/Set Email Login'), [('emailLog') : 'Binarbootcamp@gmail.com'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Edit Profile Belajar/Upload Foto'), [:], FailureHandling.STOP_ON_FAILURE)
